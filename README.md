...
**Dao Quant Research** 是一个专注于 **中国 A 股市场量化分析** 的研究知识库，收录 **199** 篇 Markdown 格式的研究文章，系统性地记录和分享基于"双引擎四层融合模型"的量化分析研究。
...
> 共收录 **199** 篇研究文章，覆盖 **29** 个子分类，按 **5 大板块** 组织

| 板块 | 目录数 | 文章数 | 平均每目录 | 说明 |
|------|:------:|:------:|:----------:|------|
| **M - 模型理论** | 7 | **28** | 4.0篇 | 双引擎四层模型完整解析 |
| **I - 行业研究** | 10 | **69** | 6.9篇 | 银行/非银/地产/医药/电子/新能源/消费/周期/TMT/制造 |
| **C - 个股案例** | 5 | 16 | 3.2篇 | 沪深300/中证500/创业板/科创板/北交所分析框架 |
| **R - 研究方法论** | 5 | **53** | 10.6篇 | 工具/数据处理/回测/随笔/文献综述 |
| **O - 开源项目** | 2 | 32 | 16篇 | 量化交易开源项目深度解析 + AI Hedge Fund Agent系列 |
| **总计** | **29** | **199** | **6.9篇** | 覆盖量化投资全流程 |
...
> 📌 **查看更多**：完整 **199** 篇文章请浏览下方 [📚 完整分类目录](#-完整分类目录)
