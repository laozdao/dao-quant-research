...
**Dao Quant Research** 是一个专注于 **中国 A 股市场量化分析** 的研究知识库，收录 **206** 篇 Markdown 格式的研究文章，系统性地记录和分享基于"双引擎四层融合模型"的量化分析研究。
...
> 共收录 **206** 篇研究文章，覆盖 **29** 个子分类，按 **5 大板块** 组织
...
| **R - 研究方法论** | 5 | **57** | 11.4篇 | 工具/数据处理/回测/随笔/文献综述 |
| **O - 开源项目** | 2 | 32 | 16篇 | 量化交易开源项目深度解析 + AI Hedge Fund Agent系列 |
| **总计** | **29** | **206** | **7.1篇** | 覆盖量化投资全流程 |
...
> 📌 **查看更多**：完整 **206** 篇文章请浏览下方 [📚 完整分类目录](#-完整分类目录)
